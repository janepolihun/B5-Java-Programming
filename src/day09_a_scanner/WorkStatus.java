...
public class WorkStatus {
    public static void main(String[] args) {
        ...
        String firstName = key.next(); // single it is a single word, we used. next();

        System.out.println("Please, enter your last name: ");
        String lastName = key.next(); // since its a single word, we used .next();

        System.out.println("Are you employed? (true/false): "); // Yes/No
