...
public class SubStringMethod {
    public static void main(String[] args) {
        ...
        System.out.println("---------------------");
        System.out.println( day.substring(0,1)); // give me the portion starting from index 0 until 0 -- > ""
        System.out.println( day.substring(0,2)); // give me the portion starting from index 0 until 1 -- > "S"
